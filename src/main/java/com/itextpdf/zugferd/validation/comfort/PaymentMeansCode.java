...
public class PaymentMeansCode extends CodeValidation {
    ...
    /** The Constant NOT_DEFINED. */
    public static final String NOT_DEFINED = "1";
    
    /** The Constant AUTOMATED_CLEARING_HOUSE. */
